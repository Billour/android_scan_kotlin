...
import com.repongroup.repon_android.prividers.AppLogDb
...
class Repon_android {
    ...
    companion object {
        private val TAG: String = "repongroup" //不可變更的Log標籤
        ...
        //常用的Toast寫成method:getcontext=app的context,getmsg=訊息,getstyle=LONG or Short
        ...
        fun checklink(view: String, mContext: Context){
            ...
            when(networkInfo.type){
                ...
                ConnectivityManager.TYPE_MOBILE -> { //使用行動網路
                    ...
                    Toast.makeText(context, msg, Toast.LENGTH_SHORT).show()
                    reponlog(view,"[自動]未連接網路",0, mContext) //寫log
                }
        ...
        //app寫log
        fun reponlog(view: String, action: String, status: Int, context: Context){
            action_view = view
        ...
        */
        fun mobiletoday(str: String): String{
            val formatter: SimpleDateFormat = SimpleDateFormat(str)
        ...
        //*工程模式登入驗證----------------------------------------------------------------------------*//
        //account驗證
        fun repon_acget(str: String): Boolean{
        ...
        //password驗證
        fun repon_pwget(str: String): Boolean{
            val getabc = str.toCharArray() //字串轉字元陣列
