...
class DBConnector {
    ...
    companion object { //相當於static效果
        var httpstate = 0
        private var result = ""
        private val timeoutConnection = 3000 //設定超時三秒
        private val timeoutSocket = 5000 //設定超時五秒
        var code = 0
        val data_ip = "http://170.168.110.49:8888/Plating/getNajPpsPam.aspx" //連公司內網下載資料
        val connect_ip = "http://170.168.110.49:8888/get.aspx" //連公司內網上傳電鍍資料
        val apktxt_ip = "http://170.168.110.49:8888/AndroidVersion/electroplating_commission/" //存放apktxt網址
        val apk_ip = "http://170.168.110.49:8888/AndroidVersion/electroplating_commission/electroplating_commission.zip" //存放apk網址
        val File_NAME = "electroplating_commission.zip"
        var file: File? = null //記錄下載完檔案解壓縮後的路徑及名稱
        ...
        fun executeapkdownload(): Int {
            ...
            try {
                ...
                val zipEntity = zipStream.nextEntry

                if (zipEntity != null){
                    val zipEntryname = zipEntity.name
